<template>
  <div>
      ...
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="status" label="订单状态">
          <template v-slot="scope">
            ...
            <el-tag type="infor" v-if="scope.row.status ==='待接单'">待接单</el-tag>
    ...
    <el-dialog title="地址信息" :visible.sync="formVisible1" width="40%" :close-on-click-modal="false" destroy-on-close>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="danger" @click="formVisible1=false">关 闭</el-button>
